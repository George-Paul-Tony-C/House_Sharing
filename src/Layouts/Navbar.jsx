...
const Navbar = () => {
  ...
  return (
    <nav className="fixed bg-blue-50 drop-shadow-xl h-16 flex items-center justify-between shadow-md w-full z-30">
      ...
      <button onClick={logout} className="mr-3 rounded-xl flex gap-2 items-center justify-center hover:bg-red-700 text-lg bg-blue-700 text-white active:scale-95 p-2 cursor-pointer">
        Logout<FaTrash />
      </button>
    </nav>
  );
